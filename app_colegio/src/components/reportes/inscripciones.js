...
export default {
    print(reportes = [], inicio, fin, ciclo = null) {
        ...
        reportes.forEach(function(rep, index) {
            ...
            content.push({
                    ...
                    columns: [{
                        ...
                        {
                            text: 'TOTAL INSCRIPCIONES: ' + rep.total,
                            alignment: 'justify',
                            margin: [0, 0, -20, 0],
                            bold: true,
                            width: 'auto'
                ...
                '\n',
                (inicio != '' && fin !== '') ? 'Informe de inscipciones del ' + desde + ' al ' + hasta + '\n\n' : 'Informe del total de inscripciones\n\n',
        ...
        pdfMake.createPdf(docDefinition).download('lista_inscripciones_' + c)
    }
}